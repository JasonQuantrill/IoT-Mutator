...
class TestWTCT(unittest.TestCase):        
    base_folder = os.path.join('C:', os.sep, 'Users', 'jason', 'OneDrive', 'Documents', 'TMU', 'CPS40A', 'IoT-Mutator')
    test_prog = os.path.join(base_folder, 'WTC-T.txl')
    ...
    def test_Base(self):
        ...
        actual_result = (
                 ...
                 'rule "Rule B"\r\n'
                 'when\r\n'
                 '    Item ItemA2 received update ON\r\n'
                 'then\r\n'
                 '    ItemB2.sendCommand (ON)\r\n'
                 'end\r\n'
                 '\r\n')
...
class TestSTCT(unittest.TestCase):        
    base_folder = os.path.join('C:', os.sep, 'Users', 'jason', 'OneDrive', 'Documents', 'TMU', 'CPS40A', 'IoT-Mutator')
    test_prog = os.path.join(base_folder, 'STC-T.txl')
